...
**PhD Candidate BI Norwegian Business School/Visiting Fellow Harvard University**
  ...
  Since August 2021, I have been affiliated with Harvard University as a Visiting Fellow at the Department of Government. In October, I will start as a Bruno Latour fellow at Sciences Po's Department of Economics, where I will be studying how trust in political elites affects green policymaking.  
...
I am also working on providing an overview of useful resources for students and researchers interesting in starting independent research using text-as-data (see [$\color{darkdarkblue}{\text{here}}$](nlp.html)). As of now, the list is mainly targeted to a Norwegian audience.
